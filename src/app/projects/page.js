...
const ProjectLanding = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      try {
        setIsLoading(true);
        const response = await axios.get("/api/projects/allProjects");
        ...
        const uniqueIndustries = [
          "All",
          ...new Set(response.data.projects.map((project) => project.industry)),
        ];
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <span className="text-2xl font-bold text-primary">ScrumLord</span>
            </motion.div>
        ...
        >
          ...
          <div className="relative">
            <Button
              ...
              onClick={() =>
                document
                  .getElementById("industry-dropdown")
                  ...
                  <CardContent className="space-y-4 flex-grow flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-muted-foreground">
                      ...
                      <div className="flex items-center gap-2">
                        <Users size={16} />
                        <span>
                          {project.RemainingMembers} of{" "}
                          {project.TotalteamMembersRequired} spots
                        </span>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          Total Team Size:{" "}
                          {selectedProject.TotalteamMembersRequired}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Users size={18} className="text-primary" />
                        <span>
                          Open Positions: {selectedProject.RemainingMembers}
                        </span>
                      </div>
                    </div>
                  </div>
